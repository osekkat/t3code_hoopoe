...
function AppWordmark() {
  return (
    <span
      aria-hidden="true"
      className="inline-flex h-5 min-w-5 shrink-0 items-center justify-center rounded-md bg-foreground px-1.5 text-[11px] font-semibold tracking-tight text-background"
    >
      H
    </span>
  );
              ...
              render={
                <SidebarMenuAction
                  render={
                    <button
                      type="button"
                      aria-label={`Create new plan in ${project.name}`}
